...
public class BDE_OrderDialog extends javax.swing.JDialog {
    ...
    String [] ArticleData = new String[4];
    String TheSign;
    ...
    private void initComponents() {
        ...
        jTable_dbData.setAutoCreateRowSorter(true);
        ...
        jPanel_foot.setPreferredSize(new java.awt.Dimension(204, 82));
        ...
        jPanel_baseLayout.setHorizontalGroup(
            ...
            .addComponent(jPanel_foot, javax.swing.GroupLayout.DEFAULT_SIZE, 693, Short.MAX_VALUE)
    ...
    private void btn_acceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_acceptActionPerformed
        ...
        if (myRow != -1) {
            this.ArticleData [0] = myTableModel.getValueAt(myRow, 0).toString().trim();
            this.ArticleData [1] = myTableModel.getValueAt(myRow, 1).toString().trim();
            this.ArticleData [2] = myTableModel.getValueAt(myRow, 2).toString().trim();
            this.ArticleData [3] = myTableModel.getValueAt(myRow, 3).toString().trim();
            this.dispose();
        }
